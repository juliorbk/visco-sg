...
public class EmailService {
  ...
  public void sendWelcomeEmail(String toEmail, String userName) {
    try {
      ...
      helper.setSubject(
        String.format("Bienvenido al sistema Visco Orinoco, %s", userName)
      );
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.08);">
                            ...
                            <tr>
                                <td style="background:linear-gradient(135deg,#5C1212 0%%,#7B1A1A 50%%,#A0302A 100%%);padding:0;">
                                    ...
                                    <!-- Dot grid overlay (inline SVG background) -->
                                                ...
                                                <table width="100%%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="vertical-align:middle;">
                                                            <!-- Inline SVG logo matching the Login page ViscoLogo -->
                            ...
                            <tr>
                                <td style="padding:44px 44px 36px 44px;">
                                        ...
                                        <tr>
                                            <td style="border-radius:10px;background:#7B1A1A;">
                                                <a href="#" target="_blank"
                                                   style="display:inline-block;padding:14px 32px;font-family:'DM Sans',Arial,sans-serif;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none;letter-spacing:0.3px;">
                                                    Iniciar sesión →
                                                </a>
                                            </td>
                                        </tr>
                                    ...
                                    <!-- Stats row (matching Dashboard KPIs) -->
