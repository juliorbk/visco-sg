...
public class WarehouseService {
    ...
    public void transferStock(TransferStockRequest request) {
        ...
        StockLevel sourceStock = stockLevelRepository
            .findByProductIdAndLocationId(request.productId(), request.fromLocationId())
            .orElseThrow(() ->
        ...
        InventoryMovement movement = InventoryMovement.builder()
            ...
            .reason(request.reason() != null ? request.reason() : "Transfer to other location") //Reason
    ...
    public void adjustStock(AdjustStockRequest request) {
        ...
        stock.setCurrentStock(stock.getCurrentStock().add(request.newStock()));
